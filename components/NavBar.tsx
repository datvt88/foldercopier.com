...
export default function NavBar() {
  return (
    <nav className="sticky top-0 z-50 backdrop-blur-md border-b border-white/10 bg-[#0a0415]/70">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center flex-wrap">
          <Link href="/" className="flex items-center gap-3">
            <div className="w-9 h-9 bg-white text-[#170934] rounded-lg flex items-center justify-center font-black text-xl leading-none shadow-[0_0_15px_rgba(255,255,255,0.3)]">
              F
            </div>
          ...
          <div className="flex items-center space-x-4 md:space-x-8 text-sm font-medium text-slate-300 mt-2 md:mt-0 overflow-x-auto">
            ...
            <Link href="/about" className="relative inline-flex items-center justify-center p-[1.5px] rounded-full overflow-hidden group">
              ...
              <span className="relative px-5 py-2 transition-all ease-in duration-75 bg-[#170934] rounded-full group-hover:bg-opacity-0 text-white font-semibold flex items-center gap-2">
                <svg width="16" height="16" className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2L15 9L22 12L15 15L12 22L9 15L2 12L9 9L12 2Z"/></svg>
                About Us
              </span>
            </Link>
          </div>
